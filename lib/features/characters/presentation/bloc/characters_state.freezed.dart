...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CharactersInitial value)?  initial,TResult Function( CharactersLoading value)?  loading,TResult Function( CharactersLoaded value)?  loaded,TResult Function( CharactersError value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CharactersInitial value)  initial,required TResult Function( CharactersLoading value)  loading,required TResult Function( CharactersLoaded value)  loaded,required TResult Function( CharactersError value)  error,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CharactersInitial value)?  initial,TResult? Function( CharactersLoading value)?  loading,TResult? Function( CharactersLoaded value)?  loaded,TResult? Function( CharactersError value)?  error,}){
final _that = this;
switch (_that) {
case CharactersInitial() when initial != null:
return initial(_that);case CharactersLoading() when loading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Character> characters,  Set<int> favoriteIds,  bool hasReachedMax,  bool isLoadingMore,  bool isOnline,  String currentFilter,  String currentSearchQuery)?  loaded,TResult Function( String message,  List<Character> cachedCharacters,  Set<int> favoriteIds)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CharactersInitial() when initial != null:
return initial();case CharactersLoading() when loading != null:
return loading();case CharactersLoaded() when loaded != null:
return loaded(_that.characters,_that.favoriteIds,_that.hasReachedMax,_that.isLoadingMore,_that.isOnline,_that.currentFilter,_that.currentSearchQuery);case CharactersError() when error != null:
return error(_that.message,_that.cachedCharacters,_that.favoriteIds);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Character> characters,  Set<int> favoriteIds,  bool hasReachedMax,  bool isLoadingMore,  bool isOnline,  String currentFilter,  String currentSearchQuery)  loaded,required TResult Function( String message,  List<Character> cachedCharacters,  Set<int> favoriteIds)  error,}) {final _that = this;
switch (_that) {
case CharactersInitial():
return initial();case CharactersLoading():
return loading();case CharactersLoaded():
return loaded(_that.characters,_that.favoriteIds,_that.hasReachedMax,_that.isLoadingMore,_that.isOnline,_that.currentFilter,_that.currentSearchQuery);case CharactersError():
return error(_that.message,_that.cachedCharacters,_that.favoriteIds);case _:
  throw StateError('Unexpected subclass');
...
class CharactersLoaded implements CharactersState {
  const CharactersLoaded({required final  List<Character> characters, required final  Set<int> favoriteIds, this.hasReachedMax = false, this.isLoadingMore = false, this.isOnline = true, this.currentFilter = 'All', this.currentSearchQuery = ''}): _characters = characters,_favoriteIds = favoriteIds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CharactersLoaded&&const DeepCollectionEquality().equals(other._characters, _characters)&&const DeepCollectionEquality().equals(other._favoriteIds, _favoriteIds)&&(identical(other.hasReachedMax, hasReachedMax) || other.hasReachedMax == hasReachedMax)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore)&&(identical(other.isOnline, isOnline) || other.isOnline == isOnline)&&(identical(other.currentFilter, currentFilter) || other.currentFilter == currentFilter)&&(identical(other.currentSearchQuery, currentSearchQuery) || other.currentSearchQuery == currentSearchQuery));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_characters),const DeepCollectionEquality().hash(_favoriteIds),hasReachedMax,isLoadingMore,isOnline,currentFilter,currentSearchQuery);

@override
String toString() {
  return 'CharactersState.loaded(characters: $characters, favoriteIds: $favoriteIds, hasReachedMax: $hasReachedMax, isLoadingMore: $isLoadingMore, isOnline: $isOnline, currentFilter: $currentFilter, currentSearchQuery: $currentSearchQuery)';
}
...
@useResult
$Res call({
 List<Character> characters, Set<int> favoriteIds, bool hasReachedMax, bool isLoadingMore, bool isOnline, String currentFilter, String currentSearchQuery
});
...
/// Create a copy of CharactersState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? characters = null,Object? favoriteIds = null,Object? hasReachedMax = null,Object? isLoadingMore = null,Object? isOnline = null,Object? currentFilter = null,Object? currentSearchQuery = null,}) {
